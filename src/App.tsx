...
const config = createConfig({initial: '', name: 'age', validationType: 'onChange'})

function App() {

  const [name, nameHandlers] = useFormField({initial: '', validationType: 'onChange'}, isRequired('please enter a name'), minLength(5))
